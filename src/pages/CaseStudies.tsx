...
const caseStudies = [
  ...
  {
    client: "Frontline Performance Group",
    industry: "Management Consulting",
    title: "Saves $100K+ Annually with Cloud Modernization",
    description: "Leading hospitality consulting firm transforms monolithic architecture to microservices on Kubernetes, achieving 99% availability and massive cost savings.",
    image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?auto=format&fit=crop&q=80&w=800",
    metrics: [
      { icon: TrendingDown, value: "$100K+", label: "Annual Savings" },
      { icon: TrendingUp, value: "99%", label: "Availability" },
      { icon: Zap, value: "4 Weeks", label: "Implementation" },
      { icon: ShieldCheck, value: "VAPT", label: "Security" },
    ],
    tags: ["Kubernetes", "Microservices", "AWS", "DevOps"],
    link: "/case-studies/frontline-performance-group",
  },
  {
    client: "enParadigm",
