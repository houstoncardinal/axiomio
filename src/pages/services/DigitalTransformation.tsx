...
import { ArrowRight, ArrowLeft, CheckCircle, Zap, Users, RefreshCw, Target, Rocket, BarChart, Puzzle, Lightbulb, GraduationCap, ChevronRight } from "lucide-react";
...
const parentCategory = getParentCategory('digital-transformation');
          ...
          <div className="container mx-auto px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              {parentCategory.subServices
                .filter(sub => sub.slug !== 'digital-transformation')
                .map((sub, index) => (
                  <motion.div
                    key={sub.id}
                    initial={{ opacity: 0, y: 30 }}
